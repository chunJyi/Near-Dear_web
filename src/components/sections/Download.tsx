...
import { MapPin, Shield, Zap, Heart, Download as DownloadIcon } from 'lucide-react';

const features = [
  { icon: Zap, text: 'Real-time tracking' },
  { icon: Shield, text: 'Per-friend privacy' },
  { icon: Heart, text: 'Friend-first design' },
];
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-lg text-neutral-600 dark:text-neutral-400">
                      Stay connected with what matters most. Available for free on Android.
                    </p>
                  ...
                  <div className="relative w-80 h-80">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <motion.div
                        ...
                        className="w-24 h-24 rounded-3xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center shadow-xl shadow-primary-500/30"
                      >
