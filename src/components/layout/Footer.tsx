        ...
        <div className="py-12 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Keep your loved ones close, no matter the distance. Real-time location sharing for families.
            </p>
        ...
        <div className="py-6 border-t border-neutral-800">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-neutral-500">
              © {new Date().getFullYear()} LocateMe. All rights reserved.
            </p>
